  ...
  return(
    <>
      <ProjectGrid>
        ...
        details={"This application aims to provide a formatted information (JSON) regarding Fire ban in Australia provided by the government of every states for mobile application called AirCamper."}></ProjectCard>
        <ProjectCard 
        projectName="My Reading list" 
        image={require("../../images/graphql-project.svg")}
        details={"I did this project out of my own interest. I saw a video on youtube that showcased GraphQL and its benefit and usecases. It intrigued me and I convinced myself to create a simple application that covers the whole CRUD operation just to familiarize myself with this amazing technology. So I did."}></ProjectCard>
        <ProjectCard 
        projectName="My Portfolio" 
        image={require("../../images/react-project.svg")}details={"This main objective of this project is to familiarize myself with React, This is the first ever solo React application that I will utilize as a portfolio to showcase my capability. I also used this website to experiment with experimental stuff and a library that I find interesting."}
        ></ProjectCard>
        <ProjectCard 
