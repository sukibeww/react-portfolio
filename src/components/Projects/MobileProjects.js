  ...
  return(
    <>
      <ProjectGrid>
        ...
        details={"This application aims to provide a formatted information (JSON) regarding Fire ban in Australia provided by the government of every states for mobile application called AirCamper."}></MobileProjectCard>
        <MobileProjectCard 
        projectName="My Reading list" 
        image={require("../../images/graphql-project.svg")}
        details={"I did this project out of my own interest. I saw a video on youtube that showcased GraphQL and its benefit and usecases. It intrigued me and I convinced myself to create a simple application that covers the whole CRUD operation just to familiarize myself with this amazing technology. So I did."}></MobileProjectCard>
        <MobileProjectCard 
